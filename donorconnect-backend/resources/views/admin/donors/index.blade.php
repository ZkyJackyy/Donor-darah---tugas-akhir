...
<div class="space-y-6">
    ...
    <div class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row gap-4">
        <form method="GET" action="{{ route('admin.donors') }}" class="flex-1 flex flex-col md:flex-row gap-4">
            ...
            <div class="relative">
                <select name="blood_type" onchange="this.form.submit()" class="appearance-none pl-4 pr-10 py-3 bg-white border border-gray-200 rounded-xl text-sm font-semibold text-gray-600 focus:outline-none focus:ring-2 focus:ring-brand-500/20 hover:border-brand-300 cursor-pointer min-w-[120px]">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @endif
                            <div class="text-[10px] text-gray-400 font-semibold mt-1">{{ $donor->donor_histories_count }}x donasi</div>
                        </td>
                        <td class="px-6 py-4">
                            @if($donor->is_available)
