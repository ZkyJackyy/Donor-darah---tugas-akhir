...
<div class="max-w-xl mx-auto">
    <div class="bg-white rounded-2xl shadow-card border border-gray-100 p-8">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h3 class="text-xl font-bold text-gray-800">Verifikasi Kehadiran Pendonor</h3>
        </div>
        ...
        <form action="{{ route('admin.verify.submit') }}" method="POST">
            ...
            <input
                ...
                class="w-full text-center text-2xl font-bold tracking-widest border border-gray-200 rounded-xl px-4 py-4 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
            ...
            <button type="submit" class="w-full mt-6 bg-brand-600 hover:bg-brand-700 text-white font-bold py-3.5 rounded-xl transition">
                Verifikasi
            </button>
        </form>
    </div>
