...
<div x-data="bloodRequestManager({{ $bloodRequest->id }})" class="space-y-8">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <button @click="openWaModal = true" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md text-sm font-medium transition duration-150 flex items-center shadow-sm">
...
document.addEventListener('alpine:init', () => {
    Alpine.data('bloodRequestManager', (requestId) => ({
        ...
        init() {
            ...
            this.intervalId = setInterval(() => this.fetchActiveCandidates(), 30000);
        },
